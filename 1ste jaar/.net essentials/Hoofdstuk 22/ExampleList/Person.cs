...
{ // maak een klasse persoon. Voorzie als properties name, firstname en birthday(DateTime)
    // Voor zie een constructor met firstname, name en birthDay(string)
    ...
    public class Person
    {
        ...
        {
            return $"{FirstName} {Name} leeftijd {Age}";
        }
